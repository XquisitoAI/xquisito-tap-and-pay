...
export default function CardScanner({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black">
      {/* Header */}
      <div className="absolute top-0 left-0 right-0 z-10 bg-linear-to-b from-black/40 to-transparent p-4">
      ...
      {/* Bottom Controls */}
      <div className="absolute bottom-0 left-0 right-0 bg-linear-to-t from-black/40 to-transparent p-6">
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="text-black py-3 rounded-full transition-colors bg-white hover:bg-stone-100 w-14 h-14 flex items-center justify-center shrink-0 cursor-pointer"
          >
